...
public class ServerThread extends Thread {
    ...
    private HashMap<String, UrlInformation> data = null;
    ...
    public synchronized void setData(String url, UrlInformation urlInformation) {
        this.data.put(url, urlInformation);
    }
